...
$AltaTrabajador= htmlspecialchars('php/Trabajadores/AltaTrabajador.php');
$ElminarTrabajador = htmlspecialchars('php/Trabajadores/ElminarTrabajador.php');
$MostrarTrabajadores = htmlspecialchars('php/Trabajadores/MostrarTrabajadores.php');
...
<head>
	...
	<script type="text/javascript" src="js/Trabajadores/AdministraDivsTrabajador.js"></script>
	<script type="text/javascript" src="js/Trabajadores/principalAcciones.js"></script>
    
  	<script type="text/javascript">
  	var AltaTrabajador ='<?php echo $AltaTrabajador; ?>';
  	var ElminarTrabajador ='<?php echo $ElminarTrabajador; ?>';
  	var MostrarTrabajadores ='<?php echo $MostrarTrabajadores; ?>';
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id ='link1'><a href="#">Mostrar Trabajadores</a></li>								  
								  <li class="active" id ='link2'><a href="#">Registro de Trabajador</a></li>							  						  
							</ul>
