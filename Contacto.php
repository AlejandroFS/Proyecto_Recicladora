...
$urlContacto = htmlspecialchars('php/Contactos/AltaContacto.php');
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/index/index.css">
  	...
  	<script type="text/javascript" src="js/Contactos/AltaContacto.js"></script>


    
  	<script type="text/javascript">
	 var urlContacto  ='<?php echo $urlContacto ; ?>';
            ...
            <li  class="both btn-is-disabled" ><a href="#" >Recolecciones pendientes</a>   <span class="fa fa-hourglass-start fa-2x" aria-hidden="true"></span></li>
                ...
                <div class="col-sm-9  ">
                  <div class="row ">
	                  ...
	                  <div class="panel panel-primary    col-md-10 col-md-offset-1 correcionPaneles2 ">
							<div class="panel-heading"  >
		                     <h3 class="panel-title">Formulario de contacto</h3>
		                      </div>
							<form id="formRegistro" action="#" class="controlPanel panel  ">
								...
								<div class="form-group resetDisplay">
									...
									<input
										...
										placeholder="Ingrese el asunto de su consulta" autofocus
								...
								<div class="form-group resetDisplay">
									...
									<input
										...
										placeholder="Ingrese algun email de contacto"
										required name="email">
								</div>
								<hr>
								<div class="form-group">
									<label >Comentarios:</label> 
									<textarea class="form-control" style="resize:none" rows="5" id="comment" name="comentarios" maxlength="400"></textarea>
								</div>
								<button type="submit" id="botonAlta" class="btn btn-default">Enviar comentario</button>
