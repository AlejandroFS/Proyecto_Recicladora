...
$urlEliminacionRecoleccion = htmlspecialchars('php/Recolecciones/RecoleccionesPendientes/EliminarRecoleccion.php');
$urlMostrarRecolecciones = htmlspecialchars('php/Recolecciones/RecoleccionesPendientes/MostrarRecolecciones.php');
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/index/index.css">
  	...
  	<script type="text/javascript" src="js/AccionesGenerales/CerrarSesion.js"></script>
   	<script type="text/javascript" src="js/RecoleccionesPendientes/AdministraRecolecciones.js"></script>
  	<script type="text/javascript" charset="utf-8" src="js/RecoleccionesPendientes/PrincipalAccionesFPendientes.js"></script>
    <script async defer
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id='link1'><a href="#">Recolecciones pendientes</a></li>								  
