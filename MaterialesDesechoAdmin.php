...
$urlAltaMaterialDesecho = htmlspecialchars('php/MaterialesDesecho/AltaMaterialDesecho.php');
$urlMostrarMateriales = htmlspecialchars('php/MaterialesDesecho/MostrarMateriales.php');
$urlEliminarMaterial = htmlspecialchars('php/MaterialesDesecho/EliminarMaterial.php');
...
<head>
	...
	<script type="text/javascript" src="js/MaterialesDesechoAdmin/AdministraDivs.js"></script>
	<script type="text/javascript" src="js/MaterialesDesechoAdmin/principalAcciones.js"></script>
	<script type="text/javascript" src="js/ValidaCamposNumericos.js"></script>
    
  	<script type="text/javascript">
  	
  	var urlAltaMaterialDesecho ='<?php echo $urlAltaMaterialDesecho; ?>';
  	var urlMostrarMateriales  ='<?php echo $urlMostrarMateriales; ?>';
  	var urlEliminarMaterial ='<?php echo $urlEliminarMaterial; ?>';
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id ='link1'><a href="#">Mostrar materiales de desecho</a></li>								  
								  <li class="active" id ='link2'><a href="#">Registro de material de desecho</a></li>							  						  
							</ul>
							<div class="modal-content panel-primary " id='panelBody'></div>
