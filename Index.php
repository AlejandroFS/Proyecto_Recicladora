...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/index/index.css">
		<link rel="stylesheet" type="text/css" href="css/index/Orden.css">
  	...
  	<script type="text/javascript" src="js/MuestraMateriales/MaterialesIndex.js"></script>
  	
	<script type="text/javascript" src="js/jquery-1.12.3.js"></script>
	<script type="text/javascript" src="js/GoogleMaps.js"></script>
  <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD-J8PzGfluEiTN4P86u5v_EY6UHsRebZs&callback=initMap">
    </script>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="http://localhost/Proyecto_Recicladora/PreciosMateriales.php">Inicio</a></li>
                   ...
                   <div class="panel panel-primary   correcionPaneles col-sm-5 col-md-offset-1 ">
                    <div class="panel-heading"  >
                     <h3 class="panel-title">Precios de Materiales de desecho.</h3>
                      ...
                      <a href="http://localhost/Proyecto_Recicladora/PreciosMateriales.php">Ver todos los precios</a>
                     </div>
                </div>
                     ...
                     <div class="panel-body" id="panelBody2">
                      ...
                      <a href="http://localhost/Proyecto_Recicladora/PreciosMateriales.php">Ver todos los precios</a>
                        ...
                        <div class="row"  >
                          ...
                          <div class="panel panel-primary    col-md-11 col-md-offset-1 correcionPaneles <?php if (isset($_SESSION["tipoUsuario"]) and ($_SESSION["tipoUsuario"] == "Usuario Administrador" ||$_SESSION["tipoUsuario"] == "Proveedor" ))
                        {echo('hideElement');
                        }?>" >
                            <div class="panel-heading   "  >
                               <h3 class="panel-title">Formulario de Recoleción</h3>
                             </div>
                              <div class="row correcionRows">
                                    <div id="map" style="width: 50%; height: 450px; display: inline-block" class="col-md-6  correcionPaneles" >
                                  
                                    </div>
                                    <div class="col-md-4 col-md-offset-1 col-md-pull-1 corrigeEsquinas">
                                             <form role="form" class="controlPanel" id="formRecoleccion">
                                             
                                             <label>Mueva el marcador del mapa con click y posicionelo sobre el lugar de recolección.</label>
                                             <label id ="estatusRegistro"></label>
                                             
												  <div class="form-group">
												    <label>Nombre completo:</label>
												    <input type="text" name="nombre" maxlength="50" class="form-control" <?php if($tipoUsuario != 'Anonimo'){echo 'readonly';} ;?> id="textFormRec" required placeholder="Ingrese su nombre"
												    value = "<?php if($tipoUsuario != 'Anonimo'){echo $valoresop['nombre'];}else{echo '';} ;?>" required placeholder="Ingrese su nombre">
												   
												  </div>
												   <div class="form-group">
												    <label >Telefono:</label>
												    <input type="tel" name="telefono" maxlength="15" class="form-control" id="telefonoFormRec" required placeholder="Ingrese algun numero de telefono">
												  </div>
												   <div class="form-group">
													  <label for="comment">Comentarios:</label>
													  <textarea name="comentarios" class = "form-control" rows="5" maxlength="100" id="commentFormRec" required style="resize:none" placeholder="Describa el material que se va a recolectar y datos sobre el docimicilio"></textarea>
													</div>
												  <hr>
												  <button type="submit" class="btn btn-success">Registrar Formulario</button>
												  <h6><strong>*Su telefono sera el utilizado como medio de contacto en un plazo menor a 24 horas.</strong></h6>
												</form>
