			...
			<div class="controlPanel  " id="divEdicion">
				<form id="formularioEdicionProv" action="#">
					<label id="estatusEdicion">Editando</label> <label
						id="idEdicionProveedor">#</label>
					<div class="form-group">
						<label for="nombre">Nombre del proveedor:</label> <input
							type="text" class="form-control" maxlength="50"
							placeholder="Ingrese el nombre del proveedor" autofocus required
							name="nombre_proveedor" id="nombreProveedor">
					</div>
					<div class="form-group">
						<label for="nombre">RFC del proveedor:</label> <input type="text"
							class="form-control" maxlength="20"
							placeholder="Ingrese el RFC del proveedor" autofocus required
							name="rfc" id="rfcProveedor">
					</div>
					<div class="form-group">
						<label for="tel">Telefono del proveedor:</label> <input type="tel"
							class="form-control" maxlength="15"
							placeholder="Ingrese el telefono del proveedor." name="telefono"
					...
					<div class="form-group">
						<label for="text">Direccion del proveedor:</label> <input
							type="text" class="form-control" maxlength="50"
							placeholder="Direccion del proveedor" required name="direccion"
							id="direccionProveedor">
					</div>
					<div class="form-group">
						<label for="text">Nickname del proveedor:</label> <input
							type="text" class="form-control" id="nicknameEdicion"
							maxlength="15" placeholder="nickname del proveedor" required
							name="nickname"> <label id="validoNicknameForm"></label>
					</div>
					<div class="form-group">
						<label for="psw">Contraseña:</label> <input type="password"
							class="form-control" maxlength="20"
							placeholder="Contraseña del proveedor." required name="password"
							id="passwordEdicion">
					</div>
					<div class="form-group">
					...
					<div class="form-group resetDisplay">
						<label for="sel1">Tipo de proveedor:</label> <select
					...
					<div class="form-group resetDisplay">
						<label for="sel1">Procedencia del proveedor:</label> <select
							class="form-control" id="list2Edicion" name="listaprocedencia">
					...
					<button type="submit" id="botonFormularioEdicion"
						class="btn btn-default" disabled>Editar al proveedor</button>
				</form>
			</div>
		...
		<div class="col-sm-6 container panel panel-primary">
			...
			<form id="formularioRegistro" action="#">
				...
				<div class="form-group">
					<label for="text">Direccion del proveedor:</label> <input
						type="text" class="form-control" maxlength="50"
						placeholder="Direccion del proveedor" required name="direccion"> <label
						id="valido2"></label>
				</div>
				<div class="form-group">
					<label for="text">Nickname del proveedor:</label> <input
						type="text" class="form-control" id="nickname" maxlength="15"
						placeholder="nickname del proveedor" required name="nickname"> <label
						id="valido2"></label>
				</div>
				...
				<div class="form-group resetDisplay">
					<label for="sel1">Procedencia del proveedor:</label> <select
						class="form-control" id="list2" name="listaprocedencia">
						<option value="1">Local</option>
						<option value="2">Foraneo</option>
					</select>
				</div>
