...
$VerificaUsuario= htmlspecialchars('php/AccionesGenerales/VerificaUsuario.php');
$EliminarCliente = htmlspecialchars('php/Clientes/EliminarCliente.php');
...
<head>
	...
	<script type="text/javascript" src="js/Clientes/AdministraDivs.js"></script>
	<script type="text/javascript" src="js/Clientes/principalAcciones.js"></script>
    
  	<script type="text/javascript">
  	var AltaCliente ='<?php echo $AltaCliente; ?>';
  	var EliminarCliente ='<?php echo $EliminarCliente; ?>';
  	var VerificaUsuario ='<?php echo $VerificaUsuario; ?>';
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id ='link1'  ><a href="#">Mostrar clientes</a></li>								  
								  <li id ='link2' class="active"><a href="#">Registro de clientes</a></li>	
								  <li id ='link3' ><a href="#">Edicion de clientes</a></li>							  						  
							</ul>
