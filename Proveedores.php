...
$EliminarProveedor = htmlspecialchars('php/Proveedores/EliminarProveedor.php');
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/index/index.css">
  	...
  	<script type="text/javascript" src="js/Proveedores/AdministraDivs.js"></script>
  	<script type="text/javascript" src="js/Proveedores/principalAcciones.js"></script>

  	<script type="text/javascript">
  	var AltaProveedor ='<?php echo $AltaProveedor; ?>';
  	var EliminarProveedor ='<?php echo $EliminarProveedor; ?>';
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id ='link1'  ><a href="#">Mostrar proveedores</a></li>								  
								  <li id ='link2' class="active"><a href="#">Registro de proveedores</a></li>	
								  <li id ='link3' ><a href="#">Edicion de proveedores</a></li>							  						  
							</ul>
