...
$urlMostrarMensajes = htmlspecialchars('php/Contactos/MostrarContactos.php');

$urlEliminacion = htmlspecialchars('php/Contactos/EliminarContacto.php');
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/index/index.css">
  	...
  	<script type="text/javascript" src="js/contactos/AdministraContactos.js"></script>
  	 	<script type="text/javascript" src="js/contactos/principalAcciones.js"></script>
  
    
  	<script type="text/javascript">
  	 var urlEliminacion = '<?php echo $urlEliminacion; ?>';
	 var urlMostrarMensajes = '<?php echo $urlMostrarMensajes; ?>';
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id ='link1'><a href="#">Mensajes en el sitio</a></li>								  
