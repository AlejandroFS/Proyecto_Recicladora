...
$urlEliminacionRecoleccion = htmlspecialchars('php/Recolecciones/RecoleccionesCompletadas/EliminarRecoleccion.php');
$urlMostrarRecolecciones = htmlspecialchars('php/Recolecciones/RecoleccionesCompletadas/MostrarRecolecciones.php');
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/index/index.css">
  	...
  	<script type="text/javascript" src="js/AccionesGenerales/CerrarSesion.js"></script>
   	<script type="text/javascript" src="js/RecoleccionesCompletadas/AdministraRecolecciones.js"></script>
  	<script type="text/javascript" charset="utf-8" src="js/RecoleccionesCompletadas/PrincipalAccionesFCompletos.js"></script>
    <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD-J8PzGfluEiTN4P86u5v_EY6UHsRebZs&callback=initMap">
    </script>
   
  	<script type="text/javascript">
	 var  	urlEliminacionRecoleccion =  '<?php echo $urlEliminacionRecoleccion; ?>';
  	 var urlMostrarRecolecciones = '<?php echo $urlMostrarRecolecciones; ?>';
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id='link1'><a href="#">Recolecciones completadas</a></li>								  
...
<div class="modal fade" id="myModal3" role="dialog">
         ...
         <!-- Modal -->
           ...
           <!-- Modal -->
           <div class="modal fade" id="myModalVisual" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content panel-primary ">
                <div class="modal-header panel-heading">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Mesaje</h4>
        </div>
