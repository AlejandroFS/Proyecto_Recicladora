		...
		$(document).on('click','#botonEspecifico', function(e){
            ...
            var arrayValues = [];
        			...
        			$.ajax({
				              ...
				              dataType: "json",
				              url: AltaOrden,
				              data: {id_cliente: variableGlobalId,hora: new Date().getFullYear()+'-'+new Date().getMonth()+'-'+new Date().getDay()+' '+ new Date().getHours()+':'+ new Date().getMinutes() + ':'+new Date().getSeconds() },
