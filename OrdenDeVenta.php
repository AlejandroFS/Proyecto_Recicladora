...
//Clientes -- editando
$MostrarClientes = htmlspecialchars('php/Clientes/MostrarClientes.php');
$AltaCliente= htmlspecialchars('php/Clientes/AltaCliente.php');
//Materiales de desecho
$DatosDesechos = htmlspecialchars('php/MaterialesReciclaje/MostrarMateriales.php');
//Items
$AltaItem = htmlspecialchars('php/ItemVenta/AltaItem.php');
$MostrarItems = htmlspecialchars('php/ItemVenta/MostrarItems.php');
$EliminaItem= htmlspecialchars('php/ItemVenta/EliminaItem.php');

//Ordenes

$Observaciones = htmlspecialchars('php/OrdenesVenta/OrdenVentaNormal/observaciones.php');
$MostrarOrdenes = htmlspecialchars('php/OrdenesVenta/OrdenVentaNormal/MostrarOrdenes.php');
$EliminarOrdenes =  htmlspecialchars('php/OrdenesVenta/OrdenVentaNormal/EliminarOrdenes.php');
$AltaOrden = htmlspecialchars('php/OrdenesVenta/OrdenVentaNormal/AltaOrden.php');
...
<head>
	...
	<script type="text/javascript" src="js/OrdenesVenta/OrdenVentaNormal/AltaOrden.js"></script>
	<script type="text/javascript" src="js/OrdenesVenta/OrdenVentaNormal/MirarOrden.js"></script>
	<script type="text/javascript" src="js/OrdenesVenta/OrdenVentaNormal/MuestraOrdenes.js"></script>
	 ...
	 var MostrarClientes ='<?php echo $MostrarClientes; ?>';
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id ='link1'  ><a href="#">Nueva orden de venta</a></li>								  
								  <li id ='link2' ><a href="#">Ordenes de venta</a></li>	
