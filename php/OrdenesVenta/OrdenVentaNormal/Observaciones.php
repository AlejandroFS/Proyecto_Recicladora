...
if ($_SERVER ["REQUEST_METHOD"] == "POST") {
	if (isset ( $_POST ['id_orden']) && isset ( $_POST ['observacion']) ) {
		$resultado = $OrdenCompra->agrgaObservacion($Utilidad->test_input($_POST ['id_orden'] ),$Utilidad->test_input($_POST ['observacion'] ));
		ob_clean ();
