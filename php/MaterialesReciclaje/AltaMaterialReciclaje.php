...
if ($_SERVER ["REQUEST_METHOD"] == "POST") {
	...
	if (! isset ( $_POST ['id_material'] )) {
		...
		$respuesta = $MaterialReciclaje->registrarMaterialReciclaje ( $arrayValues, $arrayTiposDatos );
		if ($respuesta) {
			$respuesta = json_encode ( array (
					'respuesta' => 'Material de Reciclaje registrado' 
			) );
		} else {
		...
		$respuesta = $MaterialReciclaje->editarMaterialReciclaje( $arrayValues, $arrayTiposDatos , $id );
		if ($respuesta) {
			$respuesta = json_encode ( array (
					'respuesta' => 'Material de Reciclaje registrado' 
			) );
