...
$AltaMaterialReciclaje = htmlspecialchars('php/MaterialesReciclaje/AltaMaterialReciclaje.php');
$MostrarMateriales = htmlspecialchars('php/MaterialesReciclaje/MostrarMateriales.php');
$EliminarMaterial = htmlspecialchars('php/MaterialesReciclaje/EliminarMaterial.php');
...
<head>
	...
	<script type="text/javascript" src="js/MaterialesReciclajeAdmin/AdministraDivs.js"></script>
	<script type="text/javascript" src="js/MaterialesReciclajeAdmin/principalAcciones.js"></script>
	<script type="text/javascript" src="js/ValidaCamposNumericos.js"></script>
    
    
  	<script type="text/javascript">
  	 var AltaMaterialReciclaje ='<?php echo $AltaMaterialReciclaje; ?>';
  	 var EliminarMaterial = '<?php echo $EliminarMaterial; ?>';
  	 var MostrarMateriales = '<?php echo $MostrarMateriales; ?>';
                  ...
                  <div class="row">
	                  <div class="col-md-11 col-md-offset-1 ">
		                  <ul class="nav nav-tabs" id='panelAdministrador'>					  
								  <li id ='link1'><a href="#">Mostrar materiales de reciclaje</a></li>								  
								  <li class="active" id ='link2'><a href="#">Registro de material de reciclaje</a></li>							  						  
							</ul>
